  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      <div className="text-teal-600">
        <svg className="h-8 text-[#1f2937]" viewBox="0 0 28 24" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            >
              ...
              <button
                className="mt-1 w-full bg-[#1f2937] px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:[bg-#a48d4d] sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
        ...
        <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
          ...
          <li>
            ...
            >
              ...
              <svg className="size-6" fill="gray-800" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
